...
unsigned char temp_read[8] = { 0, 0, 0, 0, 0, 0, 0, 0 };
unsigned char tach[8] = { 0, 0, 0, 0, 0, 0, 0, 0};
...
#define DEVICE_NAME "MINI Dash" //{"Group":"General","Name":"DEVICE_NAME","Title":"Device name,\r\n make sure to use a unique name when using multiple arduinos","DefaultValue":"SimHub Dash","Type":"string","Template":"#define DEVICE_NAME \"{0}\""}
#define DEVICE_UNIQUE_ID "de9ef16a-cd79-4415-b0e5-d5126d18a4dc" //{"UniqueId":"de9ef16a-cd79-4415-b0e5-d5126d18a4dc","Name":"DEVICE_UNIQUE_ID","Type":"uniqueid"}
...
#define ENABLE_TEMPGAUGE 1    //{"Name":"TEMP_PIN","Title":"TEMP pwm pin","DefaultValue":"5","Type":"pin;Temperature signal","Condition":"ENABLE_TEMPGAUGE >0"}
...
void loop() {
    CAN.sendMsgBuf(0x153, 0, 0, 8, speed);
    CAN.sendMsgBuf(0x329, 0, 0, 8, temp_read);
    CAN.sendMsgBuf(0x316, 0, 0, 8, tach);
#ifdef INCLUDE_SHAKEITL298N
